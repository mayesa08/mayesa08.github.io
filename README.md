...
1. Daftar transaksi sebelumnya.
2. Jumlah transaksi.
3. Total pendapatan parkir.
4. Informasi kendaraan yang telah keluar.
...
Teknologi	Kegunaan
HTML	Membuat struktur dan elemen halaman website
CSS	Mengatur desain, layout, warna, ukuran, dan tampilan website
